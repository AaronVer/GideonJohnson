...
//Annotations are used to connect external information to lines of code. In this case
// they are being used to open up the table named "Director" to interact with.
@Entity
@Table(name="director")
